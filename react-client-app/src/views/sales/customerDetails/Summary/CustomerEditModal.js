...
function CustomerEditModal({
  open, onSubmit, onClose, customer, className, ...rest
}) {
          ...
          <CardContent>
            ...
            >
              ...
              <Grid
                ...
                xs={12}
              >
                <Typography variant="h5">Eligible for credit</Typography>
                <Typography variant="body2">
                  This will determine is use can take credit
                </Typography>
                <Switch
              ...
              >
                ...
                <Typography variant="body2">
                  Disabling sends the user a verification email
                </Typography>
                <Switch
